...
const options = {
    ...
    definition: {
        ...
        tags: [ //Swagger UI respects the order of these
            ...
            {name: "MapSegmentCleanOrderCapability", description: "Map segment clean order capability"},
            {name: "MultipleMapCapability", description: "Multiple map capability"},
            {name: "MultipleMapRenameCapability", description: "Multiple map rename capability"},
            {name: "MultipleMapRotateCapability", description: "Multiple map rotate capability"},
            {name: "MultipleMapDeleteCapability", description: "Multiple map delete capability"},
            ...
            {name: "SpeakerPlayAudioCapability", description: "Speaker audio playback capability"},
