...
/**
 * @extends MultipleMapDeleteCapability<import("../DreameValetudoRobot")>
 */
class DreameMultipleMapDeleteCapability extends MultipleMapDeleteCapability {
    /**
     *
        ...
        if (
            ...
            switch (res.out[0].value) {
                case 0:
                    ...
                    return;
                default:
                    throw new RobotFirmwareError("Got error " + res.out[0].value + " while deleting map.");
            }
        }
    }
}

module.exports = DreameMultipleMapDeleteCapability;
