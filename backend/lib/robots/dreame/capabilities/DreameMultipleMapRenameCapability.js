...
/**
 * @extends MultipleMapRenameCapability<import("../DreameValetudoRobot")>
 */
class DreameMultipleMapRenameCapability extends MultipleMapRenameCapability {
    /**
     *
        ...
        if (
            ...
            switch (res.out[0].value) {
                case 0:
                    ...
                    return;
                default:
                    throw new RobotFirmwareError("Got error " + res.out[0].value + " while renaming map.");
            }
        }
    }
}

module.exports = DreameMultipleMapRenameCapability;
